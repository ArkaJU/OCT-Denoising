...
def show_on_epoch_end(epoch_time, valid_time, valid_loss, valid_psnr, valid_ssim, valid_ssim2):
    """Formats validation error stats."""

    clear_line()
    print('Train time: {} | Valid time: {} | Valid loss: {:>1.5f} | Avg PSNR: {:.2f} dB | Avg SSIM: {:.2f} | Avg SSIM2: {:.2f}'.format(epoch_time, valid_time, valid_loss, valid_psnr, valid_ssim, valid_ssim2))
